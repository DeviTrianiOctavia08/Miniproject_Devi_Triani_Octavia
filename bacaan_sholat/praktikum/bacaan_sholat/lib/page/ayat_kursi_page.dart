                  ...
                  children: [
                    Center(
                      child: Text(
                        ...
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 24, // Ukuran teks "Bismillah"
                            fontWeight: FontWeight.bold),
                      ),
                    ),
                    Center(
                      child: Text(
                        ...
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 16, // Ukuran teks deskripsi "Bismillah"
                    ...
                    SelectableText(
                      ...
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 24, // Ukuran teks Ayat Kursi
                          fontWeight: FontWeight.bold),
                    ...
                    Container(
                      ...
                      child: SelectableText(
                        ...
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 16, // Ukuran teks deskripsi Ayat Kursi
                            fontStyle: FontStyle.italic),
                        textAlign: TextAlign.justify,
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: SelectableText(
                        ...
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 18, // Ukuran teks terjemahan Ayat Kursi
                        ),
                        textAlign: TextAlign.justify,
                      ),
                    ),
